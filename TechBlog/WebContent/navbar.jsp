<nav class="navbar navbar-expand-lg navbar-dark  primary">
  <a class="navbar-brand" href="index.jsp"><span class="fa fa-rocket fa-spin"></span>Techblog</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Learn DSA</a>
          <a class="dropdown-item" href="#">Trending tech</a>
          <a class="dropdown-item" href="#">Today's hot picks</a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="login.jsp"><span class="fa fa-user-circle"></span> Log in</a>
      </li>
